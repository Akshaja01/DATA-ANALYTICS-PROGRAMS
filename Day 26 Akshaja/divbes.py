...
st.set_page_config(page_title="Divisive clustering in obesity data", page_icon="🍇", layout="wide")
st.title("🍉 Divisive clustering in obesity data🍉")
...
fig2=px.scatter(df,x='Age',y='Weight',color='clust2')
st.plotly_chart(fig2)

fig3=px.scatter(df,x='Age',y='Weight',color='clust3')
st.plotly_chart(fig3)

fig4=px.scatter(df,x='Age',y='Weight',color='clust4')
